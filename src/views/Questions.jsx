  ...
  return (
    <section className='questions'>
      ...
      <div className='asked-questions'>
        <details>
          <summary>Whats is Bookmark?<img src='./src/assets/images/icon-arrow.svg'/></summary>
        ...
        <details>
          <summary>How can I request a new browser?<img src='./src/assets/images/icon-arrow.svg'/></summary>
        ...
        <details>
          <summary>Is there a mobile app?<img src='./src/assets/images/icon-arrow.svg'/></summary>
        ...
        <details>
          <summary>What about other Chromium browsers?<img src='./src/assets/images/icon-arrow.svg'/></summary>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sequi numquam ut repellat culpa obcaecati possimus quasi dolore dignissimos ipsum consequatur minima amet aut deleniti alias, voluptates a cumque molestias officiis.
        </details>
